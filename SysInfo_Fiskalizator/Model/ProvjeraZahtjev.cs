...
namespace SysInfo_Fiskalizator.Model
{
    ...
    public class ProvjeraZahtjev : EntityBaseType<ProvjeraZahtjev>
    {
        ...
        /// <summary>Generira novi inicijalizirani ProvjeraZahtjev</summary>
        /// <param name="invoice">Račun</param>
        /// <returns>Inicijalizirani ProvjeraZahtjev</returns>
        /// <exception cref="ArgumentNullException">Ulazni parametar nije zadan</exception>
        public static ProvjeraZahtjev GetInitialized(RacunType invoice)
        {
            #region Input parameter testing

            if (invoice == null)
            {
                throw new ArgumentNullException("invoice", "Method: ProvjeraZahtjev.GetInitialized Parameter: invoice");
            }
